    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _ArticleTitleAndDescription(article: article),
          _ArticleRemovableArea(
            article: article!,
...
class _ArticleTitleAndDescription extends StatelessWidget {
  final ArticleEntity? article;

  const _ArticleTitleAndDescription({
    this.article,
    super.key,
  });
...
class _ArticleRemovableArea extends StatelessWidget {
  final ArticleEntity? article;
